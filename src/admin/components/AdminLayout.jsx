...
import {
  ...
  Shield, Settings, LogOut, ChevronLeft, ChevronRight, Search, Bell, Menu,
} from 'lucide-react';
  ...
  const SidebarContent = () => (
    <div className="flex flex-col h-full">
      ...
      <div className="flex items-center gap-3 px-5 h-16 border-b" style={{ borderColor: 'rgba(255,255,255,0.06)' }}>
        ...
        {!collapsed && <span className="text-sm font-extrabold text-white tracking-tight">SkillSync Admin</span>}
      </div>
