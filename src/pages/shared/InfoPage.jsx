...
const InfoPage = () => {
  ...
  const templates = {
      ...
      content: (
        <div className="space-y-6">
          <p className="leading-relaxed">
            SkillSync was founded in 2026 with a bold vision: to bridge the gap between clients needing instant services and independent professionals working locally. Traditional marketplace platforms focus entirely on remote, global assignments, leaving local and proximity-based talent underserved. 
          </p>
          ...
          <p className="leading-relaxed">
            Whether you are a developer, designer, writer, plumber, or electrician, SkillSync provides the infrastructure to build a sustainable, trusted local business.
          </p>
        </div>
      )
    },
    'how-to-hire': {
      icon: Briefcase,
      color: '#4f46e5',
      title: 'How to Hire on SkillSync',
    ...
    'careers': {
      icon: Sparkles,
      color: '#8b5cf6',
      title: 'Careers at SkillSync',
      subtitle: 'We are hiring! Help us build the ultimate local freelance platform.',
      content: (
        <div className="space-y-6">
          <p className="leading-relaxed">
            At SkillSync, we are a fast-paced, product-obsessed team based in Bhopal, MP. We are backed by premium startup incubators and work on solving hard real-world location-based service challenges.
          </p>
    ...
    'contact-us': {
      ...
      color: '#ec4899',
      title: 'Contact Us',
      subtitle: 'Get in touch with the SkillSync team. We are here to help.',
      content: (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="space-y-4">
            <h4 className="text-xs font-bold text-foreground uppercase tracking-wider">Support Channels</h4>
            {[
              { icon: Mail, label: 'Email Support', val: 'support@skillsync.com' },
              { icon: Phone, label: 'Helpline', val: '+91 755 123 4567' },
              { icon: MapPin, label: 'HQ Address', val: 'SkillSync Labs, MP Nagar, Bhopal, India' },
            ].map((c, i) => (
    ...
    'our-vision': {
      ...
      content: (
        <div className="space-y-6">
          <p className="leading-relaxed">
            By decentralizing professional marketplace opportunities, SkillSync envisions a future where skilled talent does not need to migrate to tier-1 metropolitan cities (such as Bangalore or Mumbai) to build premium careers.
          </p>
          <p className="leading-relaxed">
    ...
    'business-solutions': {
      ...
      content: (
        <div className="space-y-4">
          <p className="leading-relaxed">
            For businesses requiring batch assignment, automated localized payroll, and contract verification support, SkillSync offers premium Business Solutions:
          </p>
    ...
    'enterprise': {
      icon: Building,
      color: '#4f46e5',
      title: 'SkillSync Enterprise',
      subtitle: 'Custom local deployment pipelines and bulk staffing for large business networks.',
      content: (
        <div className="space-y-6">
          <p className="leading-relaxed">
            SkillSync Enterprise delivers managed localized workforce solutions for corporate groups, regional agencies, and franchises. We supply API endpoints, custom geofenced recruitment portals, and automated tax compliance support for companies managing 50+ local contractors simultaneously.
          </p>
    ...
    'direct-contracts': {
      ...
      subtitle: 'Invoice off-platform clients using SkillSync secure escrow at 0% fees.',
      content: (
        <div className="space-y-6">
          <p className="leading-relaxed">
            Met an interesting client on social media or in-person? You can bring them to SkillSync to execute contract terms. Protect yourself against non-payments using our secure digital escrow vault with <strong>zero platform fee</strong> charges.
          </p>
    ...
    'skillsync-pro': {
      icon: Sparkles,
      color: '#f59e0b',
      title: 'SkillSync Pro Membership',
      subtitle: 'Premium lead badges and reduced transaction fees for scaling specialists.',
      content: (
        <div className="space-y-6">
          <p className="leading-relaxed">
            Elevate your freelance business with <strong>SkillSync Pro</strong>. Designed for established local contractors, Pro membership offers advanced features to double your client pipeline and lower payment collection costs.
          </p>
          <div className="border border-border rounded-2xl overflow-hidden bg-card">
            <div className="bg-amber-500/10 px-5 py-4 border-b border-border flex items-center justify-between">
              <div>
                <span className="text-xs font-bold text-amber-600 dark:text-amber-400">SkillSync Pro Plan</span>
    ...
    'success-stories': {
      ...
      subtitle: 'Read how local service providers in India are scaling their income on SkillSync.',
      content: (
        <div className="space-y-6">
          <p className="leading-relaxed">
            SkillSync has enabled offline professionals across Tier-2 and Tier-3 cities in India to find reliable, high-paying clients locally. Here is what some of our verified members say:
          </p>
          <div className="space-y-4">
            {[
              { name: 'Rajesh Kumar', role: 'Verified Electrician', city: 'Bhopal, MP', quote: 'SkillSync completely changed my plumbing & electrical business. Earlier, I waited in the market for daily wage jobs. Now I get contract bookings directly on my phone from clients just 2 km away in MP Nagar.', rating: 5 },
              { name: 'Amit Sharma', role: 'Full-Stack Developer', city: 'Indore, MP', quote: 'I graduated in Indore and wanted to work locally instead of migrating to Bangalore. Through SkillSync, I found three local startup clients who hired me for website updates. I work from home and get paid securely via escrow.', rating: 5 },
              { name: 'Priya Verma', role: 'Graphic Designer', city: 'Jabalpur, MP', quote: 'As a student designer, getting local client trust was hard. SkillSync KYC badge gave clients confidence. I have completed 15+ brochures and branding projects within Jabalpur.', rating: 5 }
            ].map((story, i) => (
    ...
    'skillsync-reviews': {
      icon: Award,
      color: '#06b6d4',
      title: 'SkillSync Platform Reviews',
    ...
    'community-forum': {
      ...
      content: (
        <div className="space-y-6">
          <p className="leading-relaxed">
            SkillSync is more than a platform — it is a thriving professional community. Join regional telegram groups, share tips, ask legal questions, or find developers and electricians to collaborate on complex assignments.
          </p>
          <div className="space-y-3">
            <h4 className="text-xs font-bold text-foreground uppercase tracking-wider">Active Regional Channels</h4>
            {[
              { city: 'SkillSync Bhopal Circle', members: '1.2K Members', desc: 'Local monthly meetups at MP Nagar coworking hubs.' },
              { city: 'SkillSync Indore Devs', members: '2.4K Members', desc: 'Tech stack collaborations, design review boards, and startup talks.' },
              { city: 'SkillSync Central India Support Forum', members: '5K Members', desc: 'General legal help, GST audits, and platform feedback.' }
            ].map((forum, i) => (
    ...
    'press-media': {
      ...
      content: (
        <div className="space-y-6">
          <div className="space-y-4">
            {[
              { date: 'June 02, 2026', title: 'SkillSync raises seed round to expand geo-freelance platform into 10 new cities', desc: 'Official announcement of seed funding round backed by prime Indian startup accelerators, targeting local market development.' },
              { date: 'May 15, 2026', title: 'SkillSync launches automated KYC trust badges powered by post-office APIs', desc: 'Revolutionary update enabling verification for service professionals across remote and suburban cities in Central India.' }
            ].map((news, i) => (
    ...
    'partners': {
      ...
      content: (
        <div className="space-y-6">
          <p className="leading-relaxed">
            SkillSync integrates with leading technology partners across India to offer secure escrow collections, accurate geocoding reverse lookups, and fast KYC checks.
          </p>
  ...
  const defaultTemplate = {
    ...
    subtitle: 'Learn more about SkillSync services, safety rules, and platform updates.',
    content: (
      <div className="space-y-6">
        <p className="leading-relaxed">
          Welcome to the SkillSync documentation portal. We are updating this section with detailed documents and guides. 
        </p>
