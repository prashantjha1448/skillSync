...
const Landing = () => {
  ...
  return (
    <div className="bg-background text-foreground transition-colors duration-300 w-full min-h-screen">
      ...
      {/* Hero Section */}
      <main className="max-w-7xl mx-auto px-6 lg:px-12 pt-20 pb-16 text-center">
      ...
      <section className="bg-muted/40 border-t border-border py-24">
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <div className="text-center mb-16">
            <h2 className="text-3xl lg:text-4xl font-bold mb-4 text-foreground">Why SkillSync?</h2>
